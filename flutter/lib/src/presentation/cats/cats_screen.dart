...
import 'package:catotinder/src/presentation/details/cat_details_screen.dart';
...
class _CatsScreenState extends State<CatsScreen> {
  ...
  Future<void> _init() async {
    ...
    int? likes = _prefs.getInt(SharedPrefsKeys.likes);
  ...
  Future<void> _onLike() async {
    // Увеличение счётчика.
    setState(() {
      _prefs.setInt(SharedPrefsKeys.likes, ++_likes);
    });
